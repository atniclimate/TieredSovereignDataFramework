...
(function () {
  ...
  var GLOSSARY = {
    ...
    "TSDF": { t: "TSDF", d: "The Tiered Sovereignty Data Framework: four tiers (T0–T3) that let Indigenous Nations govern how their data is shared while protecting sensitive and culturally restricted information." },
    ...
    "Data Actor Model": { t: "Data Actor Model", d: "From IEEE 2890-2025: both humans and non-humans (algorithms, databases, AI systems) are “actors” that touch data — and every non-human actor must have a responsible human identified." },
    ...
    "IEEE 2890-2025": { t: "IEEE 2890-2025", d: "The world's first international technical standard for Indigenous data provenance (published November 2025) — common parameters for documenting data origins, stewardship, and movement. TSDF adopts it as its authoritative provenance reference." }
  };
  ...
  var CLAIMS_2 = [
    ...
    { txt: "In 2025 the IEEE ratified <strong>2890-2025, the world's first international standard for provenance of Indigenous Peoples' data</strong> — TSDF adopts it as its authoritative provenance reference.", src: "IEEE Standards Association, 2890-2025", url: "https://standards.ieee.org/ieee/2890/10318/" },
    { txt: "<strong>OCAP®</strong> — established 1998, trademarked 2015 — is a certified, teachable standard for First Nations data governance, with formal training and certification.", src: "First Nations Information Governance Centre", url: "https://fnigc.ca/ocap-training/" },
  ...
  /* ================= TABS ================= */
  var TAB_NAMES = ["overview", "standard", "practice", "evidence", "adopt"];
