...
The Tiered Sovereign Data Framework (TSDF) provides Indigenous Nations with a clear, operational mechanism for data governance in digital spaces. It translates foundational Indigenous data sovereignty principles into practical, actionable classifications for software and computational infrastructure. Tribal law and regulations remain supreme within Tribal jurisdiction, and TSDF honors and adheres to them. It is not meant to replace any Sovereign framework(s) or cultural ways-of-knowing, rather it is intended for consideration and utilization within development environments to ensure governance compliance, secure sharing and transmission of digital data.
